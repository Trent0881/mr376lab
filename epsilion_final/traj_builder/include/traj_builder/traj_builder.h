...
public:
    ...
    void build_point_and_go_traj(geometry_msgs::PoseStamped start_pose,
            geometry_msgs::PoseStamped end_pose,
            std::vector<nav_msgs::Odometry> &vec_of_states);
    void build_braking_traj(geometry_msgs::PoseStamped start_pose,   nav_msgs::Odometry current_des_state_ ,
            std::vector<nav_msgs::Odometry> &vec_of_states);

    void build_backward_traj(geometry_msgs::PoseStamped current_pose,std::vector<nav_msgs::Odometry> &vec_of_states);
